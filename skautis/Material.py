...
class Material(object):
    ...
    def StockTakingAll(self, ID_Login, ID_Unit, ID, ID_Person, ID_DocumentStockTaking, ID_DocumentProtocol, ID_StockTakingState=None):
        return self._client.service.StockTakingAll({"ID_Login": ID_Login, "ID_Unit": ID_Unit, "ID": ID, "ID_Person": ID_Person, "ID_DocumentStockTaking": ID_DocumentStockTaking, "ID_DocumentProtocol": ID_DocumentProtocol, "ID_StockTakingState": ID_StockTakingState})
    ...
    def StockTakingUpdateState(self, ID_Login, ID, ID_Person, Date, Created, ID_DocumentStockTaking, ID_DocumentProtocol, ID_DocumentStockTakingTempFile, ID_DocumentProtocolTempFile, ID_Unit, ID_StockTakingState=None, StockTakingState=None, Person=None, Note=None, Unit=None, UnitFullName=None, RegistrationNumber=None, Warehouses=None):
        return self._client.service.StockTakingUpdateState({"ID_Login": ID_Login, "ID": ID, "ID_Person": ID_Person, "Date": Date, "Created": Created, "ID_DocumentStockTaking": ID_DocumentStockTaking, "ID_DocumentProtocol": ID_DocumentProtocol, "ID_DocumentStockTakingTempFile": ID_DocumentStockTakingTempFile, "ID_DocumentProtocolTempFile": ID_DocumentProtocolTempFile, "ID_Unit": ID_Unit, "ID_StockTakingState": ID_StockTakingState, "StockTakingState": StockTakingState, "Person": Person, "Note": Note, "Unit": Unit, "UnitFullName": UnitFullName, "RegistrationNumber": RegistrationNumber, "Warehouses": Warehouses})

    # Upravit inventuru
    def StockTakingUpdate(self, ID_Login, ID, ID_Person, Date, Created, ID_DocumentStockTaking, ID_DocumentProtocol, ID_DocumentStockTakingTempFile, ID_DocumentProtocolTempFile, ID_Unit, ID_StockTakingState=None, StockTakingState=None, Person=None, Note=None, Unit=None, UnitFullName=None, RegistrationNumber=None, Warehouses=None):
        return self._client.service.StockTakingUpdate({"ID_Login": ID_Login, "ID": ID, "ID_Person": ID_Person, "Date": Date, "Created": Created, "ID_DocumentStockTaking": ID_DocumentStockTaking, "ID_DocumentProtocol": ID_DocumentProtocol, "ID_DocumentStockTakingTempFile": ID_DocumentStockTakingTempFile, "ID_DocumentProtocolTempFile": ID_DocumentProtocolTempFile, "ID_Unit": ID_Unit, "ID_StockTakingState": ID_StockTakingState, "StockTakingState": StockTakingState, "Person": Person, "Note": Note, "Unit": Unit, "UnitFullName": UnitFullName, "RegistrationNumber": RegistrationNumber, "Warehouses": Warehouses})
    ...
    # Načíst seznam půjčených položek do jednotky
    def WarehouseItemAllBorrowed(self, ID_Login, ID_Unit, ID, IncludeChild, EventRent, UnitRent, CommercialRent, IsDelete, InWarehouse, Count, RowMin, Reverse, ShowOnlyUnfinished, DisplayName=None, InventoryNumber=None, ID_WarehouseArray=None, ID_WarehouseTagArray=None, Sort=None, ID_WarehouseItemCategory=None):
        return self._client.service.WarehouseItemAllBorrowed({"ID_Login": ID_Login, "ID_Unit": ID_Unit, "ID": ID, "IncludeChild": IncludeChild, "EventRent": EventRent, "UnitRent": UnitRent, "CommercialRent": CommercialRent, "IsDelete": IsDelete, "InWarehouse": InWarehouse, "Count": Count, "RowMin": RowMin, "Reverse": Reverse, "ShowOnlyUnfinished": ShowOnlyUnfinished, "DisplayName": DisplayName, "InventoryNumber": InventoryNumber, "ID_WarehouseArray": ID_WarehouseArray, "ID_WarehouseTagArray": ID_WarehouseTagArray, "Sort": Sort, "ID_WarehouseItemCategory": ID_WarehouseItemCategory})
    ...
    # Načíst seznam položek jednotky
    def WarehouseItemAll(self, ID_Login, ID_Unit, ID, IncludeChild, EventRent, UnitRent, CommercialRent, IsDelete, InWarehouse, Count, RowMin, Reverse, DisplayName=None, InventoryNumber=None, ID_WarehouseArray=None, ID_WarehouseTagArray=None, Sort=None, ID_WarehouseItemCategory=None):
    ...
    # Založit položku
    def WarehouseItemInsert(self, ID_Login, ID, ID_Unit, ID_Event, ID_Warehouse, ID_TempFile, PurchaseDate, PurchaseYear, PurchasePrice, ActualPrice, DeletionDate, EventRent, UnitRent, CommercialRent, RentPrice, EventName=None, DisplayName=None, Warehouse=None, ID_WarehouseItemCategory=None, WarehouseItemCategory=None, InventoryNumber=None, Description=None, FileExtension=None, ID_PurchaseType=None, PurchaseType=None, PurchaseNote=None, SerialNumber=None, Sails=None, AccountNumber=None, DeletionNote=None, RentNote=None, Note=None, Tags=None):
        return self._client.service.WarehouseItemInsert({"ID_Login": ID_Login, "ID": ID, "ID_Unit": ID_Unit, "ID_Event": ID_Event, "ID_Warehouse": ID_Warehouse, "ID_TempFile": ID_TempFile, "PurchaseDate": PurchaseDate, "PurchaseYear": PurchaseYear, "PurchasePrice": PurchasePrice, "ActualPrice": ActualPrice, "DeletionDate": DeletionDate, "EventRent": EventRent, "UnitRent": UnitRent, "CommercialRent": CommercialRent, "RentPrice": RentPrice, "EventName": EventName, "DisplayName": DisplayName, "Warehouse": Warehouse, "ID_WarehouseItemCategory": ID_WarehouseItemCategory, "WarehouseItemCategory": WarehouseItemCategory, "InventoryNumber": InventoryNumber, "Description": Description, "FileExtension": FileExtension, "ID_PurchaseType": ID_PurchaseType, "PurchaseType": PurchaseType, "PurchaseNote": PurchaseNote, "SerialNumber": SerialNumber, "Sails": Sails, "AccountNumber": AccountNumber, "DeletionNote": DeletionNote, "RentNote": RentNote, "Note": Note, "Tags": Tags})
    ...
    # Upravit výpůjčku
    def WarehouseItemRentUpdate(self, ID_Login, ID, ID_WarehouseItem, ID_WarehouseItemReservation, StartDate, EndDate, IsActive, WarehouseItem=None, Note=None):
        return self._client.service.WarehouseItemRentUpdate({"ID_Login": ID_Login, "ID": ID, "ID_WarehouseItem": ID_WarehouseItem, "ID_WarehouseItemReservation": ID_WarehouseItemReservation, "StartDate": StartDate, "EndDate": EndDate, "IsActive": IsActive, "WarehouseItem": WarehouseItem, "Note": Note})

    # Načíst seznam rezervací
    def WarehouseItemReservationAll(self, ID_Login, ID_WarehouseItem, ID, ID_User, ID_Warehouse, FutureOnly, ID_WarehouseItemReservationState=None):
        return self._client.service.WarehouseItemReservationAll({"ID_Login": ID_Login, "ID_WarehouseItem": ID_WarehouseItem, "ID": ID, "ID_User": ID_User, "ID_Warehouse": ID_Warehouse, "FutureOnly": FutureOnly, "ID_WarehouseItemReservationState": ID_WarehouseItemReservationState})

    # Smazat rezervaci
    def WarehouseItemReservationDelete(self, ID_Login, ID):
        return self._client.service.WarehouseItemReservationDelete({"ID_Login": ID_Login, "ID": ID})

    # Načíst detail rezervace
    def WarehouseItemReservationDetail(self, ID_Login, ID):
        return self._client.service.WarehouseItemReservationDetail({"ID_Login": ID_Login, "ID": ID})

    # Založit rezervaci
    def WarehouseItemReservationInsert(self, ID_Login, ID, ID_User, ID_Submitter, ID_Warehouse, ID_Event, ID_Unit, ID_WarehouseOrigin, ID_UnitOrigin, ID_WarehouseItem, EstimatedStartDate, EstimatedEndDate, RealStartDate, RealEndDate, Returned, Submitter=None, Warehouse=None, Event=None, Unit=None, UnitRegistrationNumber=None, WarehouseOrigin=None, UnitOrigin=None, UnitOriginRegistrationNumber=None, WarehouseItem=None, ID_WarehouseItemReservationState=None, WarehouseItemReservationState=None, Person=None, Phone=None, Email=None, Note=None):
        return self._client.service.WarehouseItemReservationInsert({"ID_Login": ID_Login, "ID": ID, "ID_User": ID_User, "ID_Submitter": ID_Submitter, "ID_Warehouse": ID_Warehouse, "ID_Event": ID_Event, "ID_Unit": ID_Unit, "ID_WarehouseOrigin": ID_WarehouseOrigin, "ID_UnitOrigin": ID_UnitOrigin, "ID_WarehouseItem": ID_WarehouseItem, "EstimatedStartDate": EstimatedStartDate, "EstimatedEndDate": EstimatedEndDate, "RealStartDate": RealStartDate, "RealEndDate": RealEndDate, "Returned": Returned, "Submitter": Submitter, "Warehouse": Warehouse, "Event": Event, "Unit": Unit, "UnitRegistrationNumber": UnitRegistrationNumber, "WarehouseOrigin": WarehouseOrigin, "UnitOrigin": UnitOrigin, "UnitOriginRegistrationNumber": UnitOriginRegistrationNumber, "WarehouseItem": WarehouseItem, "ID_WarehouseItemReservationState": ID_WarehouseItemReservationState, "WarehouseItemReservationState": WarehouseItemReservationState, "Person": Person, "Phone": Phone, "Email": Email, "Note": Note})

    # Načíst seznam stavů rezervací
    def WarehouseItemReservationStateAll(self, ID_Login, ID=None):
        return self._client.service.WarehouseItemReservationStateAll({"ID_Login": ID_Login, "ID": ID})

    # Potvrdit rezervaci
    def WarehouseItemReservationUpdateAccepted(self, ID_Login, ID, ID_User, ID_Submitter, ID_Warehouse, ID_Event, ID_Unit, ID_WarehouseOrigin, ID_UnitOrigin, ID_WarehouseItem, EstimatedStartDate, EstimatedEndDate, RealStartDate, RealEndDate, Returned, Submitter=None, Warehouse=None, Event=None, Unit=None, UnitRegistrationNumber=None, WarehouseOrigin=None, UnitOrigin=None, UnitOriginRegistrationNumber=None, WarehouseItem=None, ID_WarehouseItemReservationState=None, WarehouseItemReservationState=None, Person=None, Phone=None, Email=None, Note=None):
        return self._client.service.WarehouseItemReservationUpdateAccepted({"ID_Login": ID_Login, "ID": ID, "ID_User": ID_User, "ID_Submitter": ID_Submitter, "ID_Warehouse": ID_Warehouse, "ID_Event": ID_Event, "ID_Unit": ID_Unit, "ID_WarehouseOrigin": ID_WarehouseOrigin, "ID_UnitOrigin": ID_UnitOrigin, "ID_WarehouseItem": ID_WarehouseItem, "EstimatedStartDate": EstimatedStartDate, "EstimatedEndDate": EstimatedEndDate, "RealStartDate": RealStartDate, "RealEndDate": RealEndDate, "Returned": Returned, "Submitter": Submitter, "Warehouse": Warehouse, "Event": Event, "Unit": Unit, "UnitRegistrationNumber": UnitRegistrationNumber, "WarehouseOrigin": WarehouseOrigin, "UnitOrigin": UnitOrigin, "UnitOriginRegistrationNumber": UnitOriginRegistrationNumber, "WarehouseItem": WarehouseItem, "ID_WarehouseItemReservationState": ID_WarehouseItemReservationState, "WarehouseItemReservationState": WarehouseItemReservationState, "Person": Person, "Phone": Phone, "Email": Email, "Note": Note})

    # Zrušit rezervaci
    def WarehouseItemReservationUpdateCancel(self, ID_Login, ID, ID_User, ID_Submitter, ID_Warehouse, ID_Event, ID_Unit, ID_WarehouseOrigin, ID_UnitOrigin, ID_WarehouseItem, EstimatedStartDate, EstimatedEndDate, RealStartDate, RealEndDate, Returned, Submitter=None, Warehouse=None, Event=None, Unit=None, UnitRegistrationNumber=None, WarehouseOrigin=None, UnitOrigin=None, UnitOriginRegistrationNumber=None, WarehouseItem=None, ID_WarehouseItemReservationState=None, WarehouseItemReservationState=None, Person=None, Phone=None, Email=None, Note=None):
        return self._client.service.WarehouseItemReservationUpdateCancel({"ID_Login": ID_Login, "ID": ID, "ID_User": ID_User, "ID_Submitter": ID_Submitter, "ID_Warehouse": ID_Warehouse, "ID_Event": ID_Event, "ID_Unit": ID_Unit, "ID_WarehouseOrigin": ID_WarehouseOrigin, "ID_UnitOrigin": ID_UnitOrigin, "ID_WarehouseItem": ID_WarehouseItem, "EstimatedStartDate": EstimatedStartDate, "EstimatedEndDate": EstimatedEndDate, "RealStartDate": RealStartDate, "RealEndDate": RealEndDate, "Returned": Returned, "Submitter": Submitter, "Warehouse": Warehouse, "Event": Event, "Unit": Unit, "UnitRegistrationNumber": UnitRegistrationNumber, "WarehouseOrigin": WarehouseOrigin, "UnitOrigin": UnitOrigin, "UnitOriginRegistrationNumber": UnitOriginRegistrationNumber, "WarehouseItem": WarehouseItem, "ID_WarehouseItemReservationState": ID_WarehouseItemReservationState, "WarehouseItemReservationState": WarehouseItemReservationState, "Person": Person, "Phone": Phone, "Email": Email, "Note": Note})

    # Upravit stav rezervace
    def WarehouseItemReservationUpdateState(self, ID_Login, ID, ID_User, ID_Submitter, ID_Warehouse, ID_Event, ID_Unit, ID_WarehouseOrigin, ID_UnitOrigin, ID_WarehouseItem, EstimatedStartDate, EstimatedEndDate, RealStartDate, RealEndDate, Returned, Submitter=None, Warehouse=None, Event=None, Unit=None, UnitRegistrationNumber=None, WarehouseOrigin=None, UnitOrigin=None, UnitOriginRegistrationNumber=None, WarehouseItem=None, ID_WarehouseItemReservationState=None, WarehouseItemReservationState=None, Person=None, Phone=None, Email=None, Note=None):
        return self._client.service.WarehouseItemReservationUpdateState({"ID_Login": ID_Login, "ID": ID, "ID_User": ID_User, "ID_Submitter": ID_Submitter, "ID_Warehouse": ID_Warehouse, "ID_Event": ID_Event, "ID_Unit": ID_Unit, "ID_WarehouseOrigin": ID_WarehouseOrigin, "ID_UnitOrigin": ID_UnitOrigin, "ID_WarehouseItem": ID_WarehouseItem, "EstimatedStartDate": EstimatedStartDate, "EstimatedEndDate": EstimatedEndDate, "RealStartDate": RealStartDate, "RealEndDate": RealEndDate, "Returned": Returned, "Submitter": Submitter, "Warehouse": Warehouse, "Event": Event, "Unit": Unit, "UnitRegistrationNumber": UnitRegistrationNumber, "WarehouseOrigin": WarehouseOrigin, "UnitOrigin": UnitOrigin, "UnitOriginRegistrationNumber": UnitOriginRegistrationNumber, "WarehouseItem": WarehouseItem, "ID_WarehouseItemReservationState": ID_WarehouseItemReservationState, "WarehouseItemReservationState": WarehouseItemReservationState, "Person": Person, "Phone": Phone, "Email": Email, "Note": Note})

    # Upravit rezervaci
    def WarehouseItemReservationUpdateReturned(self, ID_Login, ID, ID_User, ID_Submitter, ID_Warehouse, ID_Event, ID_Unit, ID_WarehouseOrigin, ID_UnitOrigin, ID_WarehouseItem, EstimatedStartDate, EstimatedEndDate, RealStartDate, RealEndDate, Returned, Submitter=None, Warehouse=None, Event=None, Unit=None, UnitRegistrationNumber=None, WarehouseOrigin=None, UnitOrigin=None, UnitOriginRegistrationNumber=None, WarehouseItem=None, ID_WarehouseItemReservationState=None, WarehouseItemReservationState=None, Person=None, Phone=None, Email=None, Note=None):
        return self._client.service.WarehouseItemReservationUpdateReturned({"ID_Login": ID_Login, "ID": ID, "ID_User": ID_User, "ID_Submitter": ID_Submitter, "ID_Warehouse": ID_Warehouse, "ID_Event": ID_Event, "ID_Unit": ID_Unit, "ID_WarehouseOrigin": ID_WarehouseOrigin, "ID_UnitOrigin": ID_UnitOrigin, "ID_WarehouseItem": ID_WarehouseItem, "EstimatedStartDate": EstimatedStartDate, "EstimatedEndDate": EstimatedEndDate, "RealStartDate": RealStartDate, "RealEndDate": RealEndDate, "Returned": Returned, "Submitter": Submitter, "Warehouse": Warehouse, "Event": Event, "Unit": Unit, "UnitRegistrationNumber": UnitRegistrationNumber, "WarehouseOrigin": WarehouseOrigin, "UnitOrigin": UnitOrigin, "UnitOriginRegistrationNumber": UnitOriginRegistrationNumber, "WarehouseItem": WarehouseItem, "ID_WarehouseItemReservationState": ID_WarehouseItemReservationState, "WarehouseItemReservationState": WarehouseItemReservationState, "Person": Person, "Phone": Phone, "Email": Email, "Note": Note})

    # Upravit rezervaci
    def WarehouseItemReservationUpdate(self, ID_Login, ID, ID_User, ID_Submitter, ID_Warehouse, ID_Event, ID_Unit, ID_WarehouseOrigin, ID_UnitOrigin, ID_WarehouseItem, EstimatedStartDate, EstimatedEndDate, RealStartDate, RealEndDate, Returned, Submitter=None, Warehouse=None, Event=None, Unit=None, UnitRegistrationNumber=None, WarehouseOrigin=None, UnitOrigin=None, UnitOriginRegistrationNumber=None, WarehouseItem=None, ID_WarehouseItemReservationState=None, WarehouseItemReservationState=None, Person=None, Phone=None, Email=None, Note=None):
        return self._client.service.WarehouseItemReservationUpdate({"ID_Login": ID_Login, "ID": ID, "ID_User": ID_User, "ID_Submitter": ID_Submitter, "ID_Warehouse": ID_Warehouse, "ID_Event": ID_Event, "ID_Unit": ID_Unit, "ID_WarehouseOrigin": ID_WarehouseOrigin, "ID_UnitOrigin": ID_UnitOrigin, "ID_WarehouseItem": ID_WarehouseItem, "EstimatedStartDate": EstimatedStartDate, "EstimatedEndDate": EstimatedEndDate, "RealStartDate": RealStartDate, "RealEndDate": RealEndDate, "Returned": Returned, "Submitter": Submitter, "Warehouse": Warehouse, "Event": Event, "Unit": Unit, "UnitRegistrationNumber": UnitRegistrationNumber, "WarehouseOrigin": WarehouseOrigin, "UnitOrigin": UnitOrigin, "UnitOriginRegistrationNumber": UnitOriginRegistrationNumber, "WarehouseItem": WarehouseItem, "ID_WarehouseItemReservationState": ID_WarehouseItemReservationState, "WarehouseItemReservationState": WarehouseItemReservationState, "Person": Person, "Phone": Phone, "Email": Email, "Note": Note})
    ...
    def WarehouseItemUpdatePhoto(self, ID_Login, ID, ID_Unit, ID_Event, ID_Warehouse, ID_TempFile, PurchaseDate, PurchaseYear, PurchasePrice, ActualPrice, DeletionDate, EventRent, UnitRent, CommercialRent, RentPrice, EventName=None, DisplayName=None, Warehouse=None, ID_WarehouseItemCategory=None, WarehouseItemCategory=None, InventoryNumber=None, Description=None, FileExtension=None, ID_PurchaseType=None, PurchaseType=None, PurchaseNote=None, SerialNumber=None, Sails=None, AccountNumber=None, DeletionNote=None, RentNote=None, Note=None, Tags=None):
        return self._client.service.WarehouseItemUpdatePhoto({"ID_Login": ID_Login, "ID": ID, "ID_Unit": ID_Unit, "ID_Event": ID_Event, "ID_Warehouse": ID_Warehouse, "ID_TempFile": ID_TempFile, "PurchaseDate": PurchaseDate, "PurchaseYear": PurchaseYear, "PurchasePrice": PurchasePrice, "ActualPrice": ActualPrice, "DeletionDate": DeletionDate, "EventRent": EventRent, "UnitRent": UnitRent, "CommercialRent": CommercialRent, "RentPrice": RentPrice, "EventName": EventName, "DisplayName": DisplayName, "Warehouse": Warehouse, "ID_WarehouseItemCategory": ID_WarehouseItemCategory, "WarehouseItemCategory": WarehouseItemCategory, "InventoryNumber": InventoryNumber, "Description": Description, "FileExtension": FileExtension, "ID_PurchaseType": ID_PurchaseType, "PurchaseType": PurchaseType, "PurchaseNote": PurchaseNote, "SerialNumber": SerialNumber, "Sails": Sails, "AccountNumber": AccountNumber, "DeletionNote": DeletionNote, "RentNote": RentNote, "Note": Note, "Tags": Tags})
    ...
    def WarehouseUpdateIsDefault(self, ID_Login, ID, ID_Unit, ID_Event, ID_WarehouseMain, IsDefault, ID_District, GpsLatitude, GpsLongitude, CanUpdate, ID_UnitCentral, DisplayName=None, ID_WarehouseType=None, WarehouseType=None, Unit=None, UnitFullName=None, RegistrationNumber=None, Event=None, WarehouseMain=None, Street=None, City=None, District=None, Postcode=None, Note=None, UnitCentral=None, UnitCentralFullName=None, UnitCentralRegistrationNumber=None):
    ...
    # Upravit sklad
    def WarehouseUpdate(self, ID_Login, ID, ID_Unit, ID_Event, ID_WarehouseMain, IsDefault, ID_District, GpsLatitude, GpsLongitude, CanUpdate, ID_UnitCentral, DisplayName=None, ID_WarehouseType=None, WarehouseType=None, Unit=None, UnitFullName=None, RegistrationNumber=None, Event=None, WarehouseMain=None, Street=None, City=None, District=None, Postcode=None, Note=None, UnitCentral=None, UnitCentralFullName=None, UnitCentralRegistrationNumber=None):
