...
class ApplicationManagement(object):
    ...
    def RemoteApplicationInsert(self, ID_Application, Enabled, IsAnonymous, IsAllActions, ID_Login, ID_Unit, ID_Person, IsPersistentLogin, ID_Role, ID_GroupLogin, DisplayName=None, Description=None, Unit=None, RegistrationNumber=None, UnitName=None, Person=None, IP=None, Url=None, UrlLoginPage=None, UrlLogoutPage=None, UrlInfoPanel=None, Role=None):
        return self._client.service.RemoteApplicationInsert({"ID_Application": ID_Application, "Enabled": Enabled, "IsAnonymous": IsAnonymous, "IsAllActions": IsAllActions, "ID_Login": ID_Login, "ID_Unit": ID_Unit, "ID_Person": ID_Person, "IsPersistentLogin": IsPersistentLogin, "ID_Role": ID_Role, "ID_GroupLogin": ID_GroupLogin, "DisplayName": DisplayName, "Description": Description, "Unit": Unit, "RegistrationNumber": RegistrationNumber, "UnitName": UnitName, "Person": Person, "IP": IP, "Url": Url, "UrlLoginPage": UrlLoginPage, "UrlLogoutPage": UrlLogoutPage, "UrlInfoPanel": UrlInfoPanel, "Role": Role})

    # Editace externí aplikace
    def RemoteApplicationUpdate(self, ID_Application, Enabled, IsAnonymous, IsAllActions, ID_Login, ID_Unit, ID_Person, IsPersistentLogin, ID_Role, ID_GroupLogin, DisplayName=None, Description=None, Unit=None, RegistrationNumber=None, UnitName=None, Person=None, IP=None, Url=None, UrlLoginPage=None, UrlLogoutPage=None, UrlInfoPanel=None, Role=None):
