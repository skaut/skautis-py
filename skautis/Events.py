...
class Events(object):
    ...
    def EventCampAll(self, ID_Login, ID_Unit, IsFuture, Started, Year, IsRelation, IsChildDirect, IsChildUnit, ForEvaluation, DisplayName=None, ID_EventCampState=None, RegistrationNumber=None, Location=None):
    ...
    # Načíst seznam táborů
    def EventCampAllZip(self, ID_Login, ID_Unit, IsFuture, Started, Year, IsRelation, IsChildDirect, IsChildUnit, ForEvaluation, DisplayName=None, ID_EventCampState=None, RegistrationNumber=None, Location=None):
