...
class Exports(object):
    ...
    def ExportGoogle(self, ID_Login, ID_ExportLog, NameFormat=None):
        return self._client.service.ExportGoogle({"ID_Login": ID_Login, "ID_ExportLog": ID_ExportLog, "NameFormat": NameFormat})

    # Uložit tiskovou sestavu s exportovanými daty pro Google - změny
    def ExportGooogleAll(self, ID_Login, ID_ExportLog):
        return self._client.service.ExportGooogleAll({"ID_Login": ID_Login, "ID_ExportLog": ID_ExportLog})

    # Uložit exportovaná data pro Seznam.cz - změny
    def ExportSeznamChanges(self, ID_Login, ID_ExportLog, NameFormat=None):
        return self._client.service.ExportSeznamChanges({"ID_Login": ID_Login, "ID_ExportLog": ID_ExportLog, "NameFormat": NameFormat})

    # Uložit tiskovou sestavu s exportovanými daty pro Seznam.cz - změny
    def ExportSeznamChangesAll(self, ID_Login, ID_ExportLog):
        return self._client.service.ExportSeznamChangesAll({"ID_Login": ID_Login, "ID_ExportLog": ID_ExportLog})

    # jubilantů
    def ExportJubilant(self, ID_Login, ID_ExportLog, NameFormat=None):
        return self._client.service.ExportJubilant({"ID_Login": ID_Login, "ID_ExportLog": ID_ExportLog, "NameFormat": NameFormat})
    ...
    # Odeslat export
    def ExportSend(self, ID_Login, ID, IsEnabled, Interval, IntervalMonth, DateNextRun, Success, DisplayName=None, Webservice=None, NameFormat=None, FileExtension=None, ID_MessageType=None, MessageType=None):
        return self._client.service.ExportSend({"ID_Login": ID_Login, "ID": ID, "IsEnabled": IsEnabled, "Interval": Interval, "IntervalMonth": IntervalMonth, "DateNextRun": DateNextRun, "Success": Success, "DisplayName": DisplayName, "Webservice": Webservice, "NameFormat": NameFormat, "FileExtension": FileExtension, "ID_MessageType": ID_MessageType, "MessageType": MessageType})
    ...
    def ExportDetail(self, ID_Login, ID, IsEnabled, Interval, IntervalMonth, DateNextRun, Success, DisplayName=None, Webservice=None, NameFormat=None, FileExtension=None, ID_MessageType=None, MessageType=None):
        return self._client.service.ExportDetail({"ID_Login": ID_Login, "ID": ID, "IsEnabled": IsEnabled, "Interval": Interval, "IntervalMonth": IntervalMonth, "DateNextRun": DateNextRun, "Success": Success, "DisplayName": DisplayName, "Webservice": Webservice, "NameFormat": NameFormat, "FileExtension": FileExtension, "ID_MessageType": ID_MessageType, "MessageType": MessageType})

    # Založit export dat
    def ExportInsert(self, ID_Login, ID, IsEnabled, Interval, IntervalMonth, DateNextRun, Success, DisplayName=None, Webservice=None, NameFormat=None, FileExtension=None, ID_MessageType=None, MessageType=None):
    ...
    def ExportKamChodit(self, ID_Login, ID_ExportLog, NameFormat=None):
        return self._client.service.ExportKamChodit({"ID_Login": ID_Login, "ID_ExportLog": ID_ExportLog, "NameFormat": NameFormat})
    ...
    def ExportSeznam(self, ID_Login, ID_ExportLog, NameFormat=None):
        return self._client.service.ExportSeznam({"ID_Login": ID_Login, "ID_ExportLog": ID_ExportLog, "NameFormat": NameFormat})

    # Uložit tiskovou sestavu s exportovanými daty pro Seznam.cz
    def ExportSeznamAll(self, ID_Login):
        return self._client.service.ExportSeznamAll({"ID_Login": ID_Login})
    ...
    # Upravit export dat
    def ExportUpdate(self, ID_Login, ID, IsEnabled, Interval, IntervalMonth, DateNextRun, Success, DisplayName=None, Webservice=None, NameFormat=None, FileExtension=None, ID_MessageType=None, MessageType=None):
